...
var GeneralConfiguration, Jelly, Logger, PluginDirectory, PluginWrapper, ReadableEntity, SharedObjectManager, Tools, TreeElement, async, fs, _Jelly;
...
Jelly = Tools.implementing(PluginWrapper, Logger, ReadableEntity, TreeElement, _Jelly = (function() {
  ...
  Jelly.prototype._constructor_ = function() {
    ...
    return this._sharedObjectManager = new SharedObjectManager();
  };
