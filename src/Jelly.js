...
var GeneralConfiguration, Jelly, Logger, PluginList, PluginWrapper, ReadableEntity, Tools, TreeElement, async, fs, _Jelly;
...
Jelly = Tools.implementing(PluginWrapper, Logger, ReadableEntity, TreeElement, _Jelly = (function() {
  ...
  Jelly.prototype._constructor_ = function() {
    ...
    return this._pluginList = new PluginList();
  };
  ...
  */
  ...
  Jelly.prototype.getPluginList = function() {
