...
var File, GeneralConfiguration, Jelly, Module, PluginHandler, ReadableEntity, Tools, TreeElement, assert, async, path, toType;
...
describe('PluginWrapper', function() {
  ...
  return describe('#applyPluginsSpecified', function() {
    it('Should be a callable function', function() {
      return assert.typeOf(PluginWrapper.prototype.applyPluginsSpecified, 'function');
    });
    it('Should return an error if the recursive parameter is not boolean', function(cb) {
      return new PluginWrapper().applyPluginsSpecified('test', function(err) {
        var e;
    ...
    it('The recursive param should be optional', function(cb) {
      return new PluginWrapper().applyPluginsSpecified(function(err) {
        var e;
    ...
    it('Should have a jelly parent', function(cb) {
      return new GeneralConfiguration().applyPluginsSpecified(function(err) {
        var e;
    ...
    it('Should work on a non-recursive way', function(cb) {
      var g, jelly;
      ...
      return jelly.getPluginDirectoryList().readAllPlugins(function(err) {
        ...
        return g.applyPluginsSpecified(false, function(err) {
          return cb(err);
        });
      });
    });
    it('Should get the plugins paramets', function(cb) {
      var g, jelly;
    ...
    it('Should raise an error if any plugin does not exist', function(cb) {
      var g, jelly;
    ...
    it('Should raise an error if any child plugin does not exist', function(cb) {
      var file, g, jelly, module;
      ...
      return jelly.getPluginDirectoryList().readAllPlugins(function(err) {
        ...
        return g.applyPluginsSpecified(true, function(err) {
          var e;
    ...
    return it('Should raise an error if any child plugin does not exist [File object]', function(cb) {
      var file, g, jelly, module;
