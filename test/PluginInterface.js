...
var File, GeneralConfiguration, Jelly, PluginDirectory, PluginHandler, assert, async, path, toType;
...
describe('PluginInterface', function() {
  ...
  return describe('#getSharedObjectManager', function() {
    it('Should be a callable function', function() {
      return assert.typeOf(PluginInterface.prototype.getSharedObjectManager, 'function');
    });
    it('Should return null if there is no jelly parent', function() {
      return assert.equal(new PluginInterface().getSharedObjectManager(), null);
    });
    return it('Should return a SharedObjectManager if there is a Jelly parent', function() {
      var jelly, pluginDirectory, pluginHandler, sharedObjectManager;
